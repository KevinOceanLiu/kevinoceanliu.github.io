...
DATA_PATH = REPO_ROOT / "data" / "ecosignal_updates.json"
RANGE_START = "2026-01-01"
CROSSREF_API = "https://api.crossref.org/journals/{issn}/works"
USER_AGENT = os.environ.get(
    "ECOSIGNAL_USER_AGENT",
    "LiuHaiyangEcoSignalMonitor/1.0 (mailto:haiyang.liu.q6@elms.hokudai.ac.jp)",
)
MAX_LANDING_FETCHES = int(os.environ.get("ECOSIGNAL_MAX_ENRICH", "20"))
OPENALEX_BATCH_SIZE = int(os.environ.get("ECOSIGNAL_OPENALEX_BATCH", "40"))

JOURNALS = [
    {
        "id": "journal-of-ecology",
        "name": "Journal of Ecology",
        "short_name": "Journal of Ecology",
        "issns": ["0022-0477"],
    },
    {
        "id": "journal-of-applied-ecology",
        "name": "Journal of Applied Ecology",
        "short_name": "Journal of Applied Ecology",
        "issns": ["0021-8901"],
    },
    {
        "id": "nature-ecology-evolution",
        "name": "Nature Ecology & Evolution",
        "short_name": "Nature Ecology & Evolution",
        "issns": ["2397-334X"],
    },
    {
        "id": "ecology-letters",
        "name": "Ecology Letters",
        "short_name": "Ecology Letters",
        "issns": ["1461-023X"],
    },
    {
        "id": "global-change-biology",
        "name": "Global Change Biology",
        "short_name": "Global Change Biology",
        "issns": ["1354-1013"],
    },
    {
        "id": "american-naturalist",
        "name": "The American Naturalist",
        "short_name": "The American Naturalist",
        "issns": ["0003-0147"],
    },
]
...
def main() -> int:
    ...
    try:
        ...
        print(f"Updated EcoSignal feed with {len(combined)} articles.")
        return 0
    except (HTTPError, URLError, TimeoutError, ValueError) as error:
        if DATA_PATH.exists():
            print(f"Keeping existing EcoSignal data due to fetch error: {error}")
            return 0
        print(f"Failed to update EcoSignal feed: {error}", file=sys.stderr)
        return 1
